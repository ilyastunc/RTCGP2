...
void IdleFunction(void)
{
	...
	float pad1_position = pad1->getPosition().y;
	float pad2_position = pad2->getPosition().y;
	float ust1, alt1,ust2,alt2;
	ust1=pad1_position+0.6;
	alt1=pad1_position-0.6;
	ust2=pad2_position+0.6;
	alt2=pad2_position-0.6;
...
void setupScene(){
    ...
    pad1 = new ScreenSpaceShaderNode("line.obj");
    
    pad2 = new ScreenSpaceShaderNode("line.obj");
    ...
    pad1->translate(-110.f, 0.f, 0.f);
    
    pad2->translate( 110.f, 0.f, 0.f);
